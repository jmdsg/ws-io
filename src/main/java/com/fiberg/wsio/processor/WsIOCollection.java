...
public final class WsIOCollection {

	private WsIOCollection() {}

	public static final Map<String, String> IMPLEMENTATIONS = ImmutableMap.<String, String>builder()
	...
	public static final Set<String> COLLECTION_INTERFACES = ImmutableSet.<String>builder()
	...
	public static final Set<String> MAP_INTERFACES = ImmutableSet.<String>builder()
			.add(Map.class.getCanonicalName())
			.add(SortedMap.class.getCanonicalName())
			.build();

	public static final Set<String> COLLECTION_CLASSES = ImmutableSet.<String>builder()
	...
	public static final Set<String> MAP_CLASSES = ImmutableSet.<String>builder()
	...
	public static final Set<String> MAPS = ImmutableSet.<String>builder()
			.addAll(MAP_INTERFACES)
			.addAll(MAP_CLASSES)
			.build();

	public static final Set<String> COLLECTIONS = ImmutableSet.<String>builder()
